...
const Hero = () => {
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      {isLoading && (
        <div className="flex-center absolute z-[100] h-dvh w-screen overflow-hidden bg-lavender-50">
      ...
      >
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            <h1 className="special-font hero-heading text-lavender-100">
              redefi<b>n</b>e
            </h1>
            <p className="mb-5 max-w-64 font-robert-regular text-lavender-100">
            ...
            <Button
              ...
              containerClass="!bg-lemon-300 flex-center gap-1"
              rightIcon={undefined}
            />
          </div>
        </div>
